 ...
 */
public final class APIMATICCalculatorTestClient implements Configuration {
    ...
    private APIMATICCalculatorTestClient(Environment environment, HttpClient httpClient,
    ...
    /**
     * Converts this APIMATICCalculatorTestClient into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "APIMATICCalculatorTestClient [" + "environment=" + environment
                + ", httpClientConfig=" + httpClientConfig + ", authManagers=" + authManagers + "]";
    }

    /**
     * Builds a new {@link APIMATICCalculatorTestClient.Builder} object.
     * Creates the instance with the state of the current client.
     * @return a new {@link APIMATICCalculatorTestClient.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link APIMATICCalculatorTestClient}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new APIMATICCalculatorTestClient object using the set fields.
         * @return APIMATICCalculatorTestClient
         */
        public APIMATICCalculatorTestClient build() {
            HttpClientConfiguration httpClientConfig = httpClientConfigBuilder.build();
            httpClient = new OkClient(httpClientConfig);

            return new APIMATICCalculatorTestClient(environment, httpClient, httpClientConfig,
                    authManagers);
        }
    }
}